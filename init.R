...
install.packages(c('stringr', 'corrgram', 'data.table', 'gbm', 'ggplot2', 'leaps', 'plyr', 'dplyr', 'ggvis', 'moments', 'Rcpp', 'data.table', 'quantreg', 'httr'), repos = 'http://cran.us.r-project.org', dependencies = c("Depends", "Imports", "LinkingTo"), INSTALL_opts = c("--no-html"))
